...
public class Constants {
    ...
    static int FIND_CRUMBS = 150;
    static int TEMP_RETREAT = 210;
    ...
    static int CLOSE_FRIEND_RADIUS = 8;
    ...
    static int[] ENEMYFLAGINDEX = {3,4,5};
    static int[] FOUNDENEMYFLAGS = {6,7,8};
    static int SYMLOC = 9;
    static int FLAGLOC = 10;
