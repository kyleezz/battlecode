...
public class NormalDuck extends Duck {
    ...
    public void run() throws GameActionException {
        ...
        if (rc.isSpawned()) {
            ...
            if (rc.hasFlag() && rc.getLocation().distanceSquaredTo(nearestFriendlyBase) > 20) {
                vibes += 15;
        ...
        if (enemies.length == 0 || (nearestEnemy != null && rc.senseMapInfo(rc.getLocation().add(rc.getLocation().directionTo(nearestEnemy.getLocation()))).isWall())) {
    ...
    public void neutralMove() throws GameActionException {
        ...
        if (bestie == null || rc.getLocation().distanceSquaredTo(nearestFriendlyBase) < 40) {
    ...
    public void moveAttack() throws GameActionException {
        ...
        for (int i = 0; i < 8; i++) {
            ...
            for (RobotInfo friend : friends) {
                if (friend.getLocation().distanceSquaredTo(newLoc) <= Constants.ATTACK_RADIUS) attack -= 60;
            }
