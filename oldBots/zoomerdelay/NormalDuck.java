...
public class NormalDuck extends Duck {
    ...
    public void run() throws GameActionException {
        ...
        if (duckState == microState.NEUTRAL && rc.getRoundNum() - lastAttacked < 6 && rc.getHealth() < Constants.IDEAL_HEALTH && friends.length != 0 && rc.getLocation().distanceSquaredTo(nearestFriendlyBase) > 20) {
            moveTowardsFriends();
    ...
    public void moveTowardsFriends() throws GameActionException {
        int bestScore = 0;
        Direction bestDir = null;
        // enemies may have changed after we attacked, friends stay the same
        ...
        for (int i = 0; i < 8; i++) {
            ...
            int score = attack + (20 - closest) * 10000;
            if (score > bestScore) {
                bestScore = score;
                bestDir = Constants.directions[i];
            } else if (score == bestScore) {
