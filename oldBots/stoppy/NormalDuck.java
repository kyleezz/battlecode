...
public class NormalDuck extends Duck {
    ...
    public void run() throws GameActionException {
        ...
        sense();
        int vibes = Math.min((enemyTeamHealth - teamHealth) / 1000, 10);
        if (rc.hasFlag()) {
            vibes += 15;
        ...
        comms.updateComms(vibes, (enemyWithFlag == null) ? null : enemyWithFlag.location);
        globalbfs.updateGrid();
    ...
    public void neutralMove() throws GameActionException {
        ...
        if (goToHelp != null && (bestVal > 0.1 && rc.getLocation().distanceSquaredTo(goToHelp) < 400)) {
            rc.setIndicatorLine(rc.getLocation(), goToHelp, 0, 255, 0);
