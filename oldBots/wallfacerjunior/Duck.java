...
public abstract class Duck {
    ...
    public MapLocation findSpawnLocation(boolean goHelp) throws GameActionException {
        ...
        int bestSpec = 1000000;
        MapLocation specSpawn = null;
        ...
        for (int i = 0; i < 27; i++) {
            ...
            if (goHelp) {
                ...
                int dist = spawnLoc.distanceSquaredTo(baseLocs[rc.getRoundNum() % 3]);
                if (dist < bestSpec) {
                    bestSpec = dist;
                    specSpawn = spawnLoc;
                }
        ...
        if (bestSpawn != null) return bestSpawn;
