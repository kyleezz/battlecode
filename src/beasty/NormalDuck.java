...
public class NormalDuck extends Duck {
    ...
    public void neutralMove() throws GameActionException {
        ...
        for (RobotInfo friend: friends) {
            ...
            int score = friend.getLocation().distanceSquaredTo(targetLocation) * 10000;
            score -= friend.getHealth();
            if (score < bestieScore) {
                bestie = friend;
                bestieScore = score;
            } else if (score == bestieScore && ((bestie == null && friend.getID() > rc.getID()) || (bestie != null && friend.getID() > bestie.getID()))) {
                bestie = friend;
            }
        }
        ...
        if (rc.getRoundNum() - lotsaFriends < 10 || bestie == null || rc.getLocation().distanceSquaredTo(bestie.getLocation()) < 2 || closeFriends > Constants.CLOSE_FRIEND_SIZE) {
