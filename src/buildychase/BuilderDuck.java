...
public class BuilderDuck extends Duck {
    ...
    public void run() throws GameActionException {
        ...
        if (rc.getRoundNum() < CHECKERBOARD && (rc.getLevel(SkillType.BUILD) < 4 || (rc.getLevel(SkillType.BUILD) < 4 && rc.getCrumbs() > 1000))) {
            // start digging
            checkerBoard();
        ...
        //     if (rc.getCrumbs() > 400 && rc.getRoundNum() < 210) {
        //         tryTrap(2, 4);
        ...
        if (rc.getCrumbs() > 1000) tryTrap(2, 0);
        tryTrap(2, 2);
    ...
    public void sense() throws GameActionException {
        ...
        nearbyTrapLocs = new MapLocation[20];
        nearbyTraps = 0;
