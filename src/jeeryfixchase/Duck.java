...
//    public MapLocation findSpawnLocation(MapLocation defendLoc) throws GameActionException {
//        int randomStart = rng.nextInt() % rc.getID();
//        MapLocation[] spawnLocs = rc.getAllySpawnLocations();
//        int bestHelp = 1000000;
//        MapLocation bestSpawn = null;
...
//            if (randomSpawn == null) randomSpawn = spawnLoc;
//            if (defendLoc != null) {
//                int dist = spawnLoc.distanceSquaredTo(defendLoc);
//                if (dist < bestHelp) {
//                    bestHelp = dist;
//                    bestSpawn = spawnLoc;
//                }
